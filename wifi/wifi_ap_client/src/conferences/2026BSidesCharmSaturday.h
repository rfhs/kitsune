...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0xA3, 0x1E, 0x82, 0x9A, 0x2E}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x88, 0x38, 0x77, 0x73, 0x74}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0xF1, 0x58, 0x14, 0xFE, 0x82}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0xB7, 0x89, 0xC3, 0x0D, 0x89}
// Network config
