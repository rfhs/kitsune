...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x0C, 0xC5, 0x62, 0x94, 0x1E}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x61, 0xB9, 0x59, 0xC0, 0xFB}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x1E, 0x53, 0x74, 0x73, 0x80}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0xC8, 0x30, 0xCD, 0x85, 0x0B}
// Network config
