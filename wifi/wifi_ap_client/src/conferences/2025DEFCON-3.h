...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x59, 0x98, 0x4F, 0x65, 0xCD}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x04, 0x4D, 0x42, 0xC4, 0x6F}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x78, 0xF2, 0x65, 0xFA, 0xB0}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x7F, 0x32, 0xE8, 0xB2, 0x9D}
// Network config
