...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0xB3, 0x8D, 0x82, 0x10, 0x9E}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0xE2, 0xC9, 0xC5, 0x02, 0xD5}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x8D, 0x92, 0xFB, 0xB1, 0x84}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0xE2, 0x8D, 0x1C, 0x78, 0x42}
// Network config
