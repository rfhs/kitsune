...
#define AP
// set mac address
#define MAC_ADDR {0xF2, 0x62, 0x36, 0x61, 0x3B, 0xFE}
// Network config
...
#define AP
// set mac address
#define MAC_ADDR {0xF2, 0x69, 0xE4, 0xD7, 0x58, 0x9D}
// Network config
...
#define CLIENT
// set mac address
#define MAC_ADDR {0xF2, 0x1F, 0x6D, 0xB8, 0xBC, 0x06}
// Network config
...
#define CLIENT
// set mac address
#define MAC_ADDR {0xF2, 0x15, 0x2A, 0x6D, 0x65, 0x01}
// Network config
