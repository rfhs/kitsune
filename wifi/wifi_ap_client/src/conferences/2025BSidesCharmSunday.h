...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0xFE, 0xBF, 0x0E, 0x36, 0xFD}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x8E, 0xD0, 0x92, 0xDF, 0x42}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x8F, 0xB7, 0x1F, 0x2F, 0xB0}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x0A, 0xA5, 0xEB, 0x00, 0xBF}
// Network config
