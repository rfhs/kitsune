...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0x99, 0x3C, 0x67, 0xEE, 0x68}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x1C, 0xBD, 0xD6, 0xA4, 0xFA}
// Network config
...
#if defined(EASY)
// set mac address
#define MAC_ADDR {0xF2, 0xD0, 0x4D, 0xAD, 0xB5, 0xDA}
// Network config
...
#if defined(HARD)
// set mac address
#define MAC_ADDR {0xF2, 0x0A, 0xD8, 0x48, 0xA0, 0xDB}
// Network config
